...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return initAnimeNumbers; });\nfunction initAnimeNumbers() {\n  function animeNumbers() {\n    const numbers = document.querySelectorAll('[data-number]');\n\n    numbers.forEach(number => {\n      const total = +number.innerText;\n      const increment = Math.floor(total / 100);\n\n      let start = 0;\n\n      const timer = setInterval(() => {\n        start += increment;\n\n        number.innerText = start;\n\n        if (start > total) {\n          number.innerText = total;\n\n          clearInterval(timer);\n        }\n      }, 25 * Math.random());\n    });\n  }\n\n  function handleMutation(mutation) {\n    if (mutation[0].target.classList.contains('active')) {\n      observer.disconnect();\n      animeNumbers();\n    }\n  }\n\n  const observerTarget = document.querySelector('.numbers');\n\n  const observer = new MutationObserver(handleMutation);\n\n  observer.observe(observerTarget, { attributes: true });\n}\n\n\n//# sourceURL=webpack:///./js/modules/anime-numbers.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return initFetchAnimals; });\n/* harmony import */ var _anime_numbers_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./anime-numbers.js */ \"./js/modules/anime-numbers.js\");\n\n\nfunction initFetchAnimals() {\n  const numbersGrid = document.querySelector('.numbers-grid');\n\n  function createAnimal(animal) {\n    numbersGrid.innerHTML += `<div class=\"number-animal\">\n      <h3>${animal.specie}</h3>\n      <span data-number>${animal.total}</span>\n    </div>`;\n  }\n\n  async function fetchAnimals(url) {\n    try {\n      const animalsResponse = await fetch(url);\n      const animalsJSON = await animalsResponse.json();\n\n      animalsJSON.forEach(animal => {\n        createAnimal(animal);\n      });\n\n      Object(_anime_numbers_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])();\n    } catch (err) {\n      console.error(err);\n    }\n  }\n\n  fetchAnimals('../../animalsapi.json');\n}\n\n\n//# sourceURL=webpack:///./js/modules/fetch-animals.js?");
